  ...
  return (
    <div className="bg-gray-200 min-h-[100vh] p-[2%]">
      <div className="bg-white rounded-lg p-12">
        <div className="text-4xl font-semibold text-gray-900 mb-10">Prijavljivanje</div>
        <div>
          ...
          <div className="grid grid-cols-7 gap-5 text-center">
            { kitchenEmployees.map((employee) => (
              ...
              >
                ...
                <div className="font-mono text-center text-base">{ printCheckinDate(employee) }{ printCheckoutDate(employee) }</div>
              </div>
            ))}
          </div>
        </div>
